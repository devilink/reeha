...
// REVERSE THE LINKS - CRITICAL STEP
// The original list was 120 -> 95, so we reverse it to be 95 -> 120
const correctedLinks = links.reverse();
...
async function run() {
    ...
    try {
        ...
        for (let i = 0; i < correctedLinks.length; i++) {
            ...
            console.log(`Assigning link to ${productName}...`);
