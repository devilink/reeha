            ...
            <div className="max-w-6xl mx-auto">
                <div className="flex justify-between items-center mb-8">
                    ...
                    <div className="flex space-x-4">
                        <Link href="/admin/testimonials" className="px-6 py-2 border border-brand-gold text-brand-gold rounded-md font-bold text-sm uppercase hover:bg-brand-gold hover:text-white transition-colors">
                            Manage Testimonials
                        </Link>
